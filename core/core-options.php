...
class plugin_options{
	...
	public static function plugin_action_links($links){
		return array_merge([
			'settings' => '<a href="' . \admin_url( 'plugins.php?page=' . self::get_options_page_slug()) . '">' . __( 'Settings', __NAMESPACE__ ) . '</a>'
		],$links);
	}
	...
	public static function get_url(){
		...
		if(!isset($caches[__NAMESPACE__]))
			$caches[__NAMESPACE__] = \admin_url('plugins.php?page=' . self::get_options_page_slug());
